...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  ghost:
    'border border-[rgba(var(--color-border),0.18)] bg-[rgba(var(--color-card),0.6)] text-[rgb(var(--color-text))] hover:border-[rgba(var(--color-border),0.28)] hover:bg-[rgba(var(--color-card),0.8)] focus-visible:bg-[rgba(var(--color-card),0.85)]',
};
